...
//static const char *DESCRIPTION =  trNOOP(" ");
//static const char *MAINMENUENTRY = trNOOP(" ");
...
//            virtual bool HasSetupOptions();
            ...
            static cSetupLine *GetSetupLine(const char *Name, const char *Plugin = NULL);
            ...
            virtual bool HasSetupOptions() {return false;}
        private:
