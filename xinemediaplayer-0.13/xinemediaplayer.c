        ...
        if (strcasecmp(id, "Set Xine Mode") == 0){
            ...
            switch (xineMode->mode) {
                ...
                case XineMediaplayer_Mode_musicbrowser:
                    ...
                    break;
                case Xinemediaplayer_Mode_webvideo: // webvideo
                    cXineOsd::k_blue = WEBVIDEO_PLUGIN;
                    break;
                default: // no plugin
                    cXineOsd::k_blue = NO_PLUGIN;
                    break;
...
*/
		 ...
		 if (cXineOsd::mrl) {
            ...
            printf("\033[0;92mXine play mrl: list size %d, isPlaylist? %d\033[0m\n",
                   ...
                   cXineOsd::isPlaylist);
            if (cXineOsd::isPlaylist && cXineOsd::playListEntries.size() > 0 && remember_playlist)
            {
...
cSetupLine *Plugin::GetSetupLine(const char *Name, const char *Plugin)
{
