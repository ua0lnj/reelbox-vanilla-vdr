...
class cMenuBrowserOpenPlaylistIf : public cMenuBrowserNavigateIf
{
    friend class cMenuBrowserOpenPlaylistOptionsIf;
    ...
    static cMenuBrowserOpenPlaylistIf *Instance(){return &instance;} 
    
    protected:
    cMenuBrowserOpenPlaylistIf(){}; 
    
    private:
    eOSState OpenNewPlaylist(cMenuFileBrowser *menu);
    eOSState AppendNewPlaylist(cMenuFileBrowser *menu);
    static cMenuBrowserOpenPlaylistIf instance;
};
...
class cMenuBrowserBrowsePlayListIf2 : public cMenuBrowserRestrictedIf
{
    friend class cMenuBrowserOpenPlaylistOptionsIf;
    ...
    /*override*/ void EnterState(cMenuFileBrowser *menu, cMenuBrowserBaseIf *lastIf = NULL, eOSState defOSState = osContinue); 
    /*override*/ void SetMode(cMenuFileBrowser *menu, browseMode mode, bool force = false) {};
    static cMenuBrowserBrowsePlayListIf2 *Instance(){return &instance;}
    ...
    static cMenuBrowserBrowsePlayListIf2 instance;
};
...
class cMenuBrowserBrowsePlayListAndCopyIf : public cMenuBrowserRequestAndNavigateIf
{
    public:
    // /*override*/ eOSState OkKey(cMenuFileBrowser *menu);
    /*override*/ eOSState BackKey(cMenuFileBrowser *menu);
    ...
    /*override*/ void EnterState(cMenuFileBrowser *menu, cMenuBrowserBaseIf *lastIf = NULL, eOSState defOSState = osContinue); 
    /*override*/ //void SetMode(cMenuFileBrowser *menu, browseMode mode, bool force = false);
    /*override*/ void AddExtraItems(cMenuFileBrowser *menu);
        
    static cMenuBrowserBrowsePlayListAndCopyIf *Instance(){return &instance;}

    protected:
    /*override*/ void Action(cMenuFileBrowser *menu);
    /*override*/ void LeaveStateDefault(cMenuFileBrowser *menu);  
    /*override*/ void SetMessage();
    /*override*/ void LeaveState(cMenuFileBrowser *menu, bool ok);
    cMenuBrowserBrowsePlayListAndCopyIf(){};

    private:
    void AddEditStrItem(cMenuFileBrowser *menu);
    static cMenuBrowserBrowsePlayListAndCopyIf instance;
...
class cMenuBrowserSavePlaylistAsIf : public cMenuBrowserRequestAndNavigateIf
{
    public:
    /*override*/ eOSState OkKey(cMenuFileBrowser *menu);
    // /*override*/ eOSState BackKey(cMenuFileBrowser *menu);
    ...
    static cMenuBrowserSavePlaylistAsIf *Instance(){return &instance;}

    protected:
    /*override*/ void Action(cMenuFileBrowser *menu);
    /*override*/ eOSState LeaveStateDefault(cMenuFileBrowser *menu);  
    /*override*/ void SetMessage();
    cMenuBrowserSavePlaylistAsIf(){};

    private:
    void AddEditStrItem(cMenuFileBrowser *menu);
    static cMenuBrowserSavePlaylistAsIf instance;
...
class cMenuBrowserPlaylistOptionsIf2 : public cMenuBrowserOptionsIf
{
    public:
    static cMenuBrowserPlaylistOptionsIf2 *Instance(){return &instance;}
    ...
    private:
    eOSState AddToPlayList(cMenuFileBrowser *menu);
    eOSState DiscardPlayList(cMenuFileBrowser *menu);
    eOSState CopyPlayListToDirectory(cMenuFileBrowser *menu);

    static cMenuBrowserPlaylistOptionsIf2 instance;
};
...
class cMenuBrowserOpenPlaylistOptionsIf : public cMenuBrowserOptionsIf
{
    public:
    static cMenuBrowserOpenPlaylistOptionsIf *Instance(){return &instance;}
    ...
    static cMenuBrowserOpenPlaylistOptionsIf instance;
};
...
class cMenuBrowserBurnPlaylistIf: public cUserIfBase
{
    public:
    /*override*/ ~cMenuBrowserBurnPlaylistIf(){}
    /*override*/ eOSState OkKey(cMenuFileBrowser *menu);
    /*override*/ eOSState BackKey(cMenuFileBrowser *menu);
    // /*override*/ eOSState AnyKey(cMenuFileBrowser *menu, eKeys Key){ return menu->StandardKeyHandling(Key); }
    /*override*/ void EnterState(cMenuFileBrowser *menu, cMenuBrowserBaseIf *lastIf = NULL, eOSState defOSState = osContinue);
    // /*override*/ void SetHelp(cMenuFileBrowser *menu); 
    static cMenuBrowserBurnPlaylistIf *Instance(){return &instance;}

    protected:
    // /*override*/ void SetMessage(){};
    cMenuBrowserBurnPlaylistIf(){};
    eOSState LeaveStateDefault(cMenuFileBrowser *menu);

    private:    
    void  BurnPlaylist(cMenuFileBrowser *menu);
    static cMenuBrowserBurnPlaylistIf instance;
};
