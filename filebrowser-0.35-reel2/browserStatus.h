...
//----------cFileBrowserStatus-------------------- 
class cFileBrowserStatus//: public cFileBrowserStatus
{
...
public:
    ...
    void Init();
//cFileBrowserStatus Get(){return *this;};
    void Reset();
    ...
    //filebrowser has received  Service call "Filebrowser set playlist entries"
    void SetPlayListEntries(std::vector<std::string> entries);
    //filebrowser has received  Service call "Filebrowser save playlist"
    std::string  SavePlaylist();
    //filebrowser has received  Service call "Filebrowser burn playlist"
    void BurnPlayList();
    ...
    xineControl GetXineControl() const; 
...
//inline
    ...
    inline xineControl cFileBrowserStatus::GetXineControl() const
    {
        return xineCtrl_;
    }
