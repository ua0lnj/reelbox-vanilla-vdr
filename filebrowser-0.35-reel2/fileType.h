...
enum efiletype
{
    ...
    tp_unspecifiedpicture, tp_unspecifiedvideo, tp_unspecifiedaudio, tp_deb, tp_po, tp_flv, tp_3gp
};
...
//    virtual bool HasInfo() const {return false;}
    ...
    virtual std::vector<std::string> GetFileInfo(std::string path) const { return std::vector<std::string>();}
...
public:
    ...
    /*override*/ bool IsXinePlayable() const {return true;}
...
public:
    ...
    /*override*/ bool IsPlayable() const {return true;}
    /*override*/ bool IsImage() const {return true;}
...
//----------cFileTypeBaseFLV-----------------------
class cFileTypeBaseFLV : public  cFileTypeBaseVideo
{
    cFileTypeBaseFLV()
    :cFileTypeBaseVideo(tp_flv){}
    static cFileTypeBaseFLV instance;
public:
    static cFileTypeBaseFLV &Instance(){return instance;}
    /*override*/ ~cFileTypeBaseFLV(){};
    static bool IsFLV(std::string path);
};

//----------cFileTypeBase3GP-----------------------
class cFileTypeBase3GP : public  cFileTypeBaseVideo
{
    cFileTypeBase3GP()
    :cFileTypeBaseVideo(tp_3gp){}
    static cFileTypeBase3GP instance;
public:
    static cFileTypeBase3GP &Instance(){return instance;}
    /*override*/ ~cFileTypeBase3GP(){};
    static bool Is3GP(std::string path);
};
