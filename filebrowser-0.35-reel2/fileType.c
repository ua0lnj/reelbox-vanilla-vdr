...
eOSState cFileType::OpenFile(cPlayListItem &item, cMenuFileBrowserBase *menu, bool asPlaylist) const
{
    return type_->OpenFile(item, menu, asPlaylist);
}

eOSState cFileType::UpdateFile(cPlayListItem &item, cMenuFileBrowserBase *menu, bool currentChanched) const
{
    return type_->UpdateFile(item, menu, currentChanched);
}
...
eOSState cFileTypeBase::UpdateFile(cPlayListItem &item, cMenuFileBrowserBase *menu, bool currentChanged) const
{
...
eOSState cFileTypeBase::OpenFile(cPlayListItem &item, cMenuFileBrowserBase *menu, bool asPlaylist) const
{
...
eOSState cFileTypeBaseXine::OpenFile(cPlayListItem &item, cMenuFileBrowserBase *menu, bool asPlaylist)  const
{
...
eOSState cFileTypeBasePicture::OpenFile(cPlayListItem &item, cMenuFileBrowserBase *menu, bool asPlaylist) const
{
    return menu->ShowFileWithImageViewer(item, asPlaylist);
}

eOSState cFileTypeBasePicture::UpdateFile(cPlayListItem &item, cMenuFileBrowserBase *menu, bool currentChanched) const
{
...
/*eOSState cFileTypeBaseCUE::OpenFile(cPlayListItem &item, cMenuFileBrowserBase *menu) const
{
    struct
    {
        char const *cuePath;
...
eOSState cFileTypeBaseMP3::UpdateFile(cPlayListItem &item, cMenuFileBrowserBase *menu, bool currentChanched) const
{
...
eOSState cFileTypeBasePlaylist::OpenFile(cPlayListItem &item, cMenuFileBrowserBase *menu, bool asPlaylist) const
{
...
eOSState cFileTypeBaseISO::OpenFile(cPlayListItem &item, cMenuFileBrowserBase *menu, bool asPlaylist) const
{
...
eOSState cFileTypeBaseDebPacket::OpenFile(cPlayListItem &item, cMenuFileBrowserBase *menu, bool asPlaylist) const
{
    std::string message;
...
eOSState cFileTypeBasePoFile::OpenFile(cPlayListItem &item, cMenuFileBrowserBase *menu, bool asPlaylist) const
{
    std::string message;
    message = tr("please wait ...");
    Skins.Message(mtInfo,message.c_str());
...
cFileTypeBaseFLV cFileTypeBaseFLV::instance;

bool cFileTypeBaseFLV::IsFLV(std::string path)
{ 
    if(strcasecmp(GetEnding(path).c_str(), "flv")
    && strcasecmp(GetEnding(path).c_str(), "FLV"))
        return false;
    return true;
}
...
cFileTypeBase3GP cFileTypeBase3GP::instance;

bool cFileTypeBase3GP::Is3GP(std::string path)
{ 
    if(strcasecmp(GetEnding(path).c_str(), "3gp")
    && strcasecmp(GetEnding(path).c_str(), "3GP"))
        return false;
    return true;
}
