...
const char *const MEDIA_DIR = "/media";
const char *const MUSIC_DIR = "/media/music";
const char *const PICTURES_DIR = "/media/pictures";
const char *const VIDEO_DIR = "/media/video";
const char *const RECORDINGS_DIR = "/media/video";
const char *const PLAYLIST_DEFAULT_PATH ="/media";
