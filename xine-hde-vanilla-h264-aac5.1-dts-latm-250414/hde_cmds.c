...
//        mHsa = hd_get_area(HDID_HDA);
	...
	mDeinit = 1;
	pthread_mutex_unlock (&mInitLock);
//	mCtrl->video_mode.norm=1;//auto 50/60
//	mCtrl->video_mode.framerate=60;
//	mCtrl->video_mode.auto_format=1;
//	mCtrl->video_mode.outputda=HD_VM_OUTDA_AC3;
//mCtrl->player[0].ac3_pts_shift=1500;
//	mCtrl->video_mode.changed++;
	hde_osd_xine_clear();
